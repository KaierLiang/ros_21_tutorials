...
% Thruster states
f_th_L = sym('ftL_', [3,1], 'real');  % Thruster force Left 
f_th_R = sym('ftR_', [3,1], 'real');  % Thruster force Left
...
matlabFunction(ut, 'File', ...
  ['generated_functions', filesep, 'func_thrusters'], 'Vars', ...
  {states, params, [f_th_L; f_th_R]},...
   'Optimize',false);
